...
PEERS = {
    1: dict(
        ...
        size_label='250 oder mehr Mitarbeitende',
    ...
    2: dict(
        ...
        branche='Fahrzeugbau',
        size_label='50–249 Mitarbeitende',  # Mittel (Direktive Jakob 2026-06-08)
    ...
    3: dict(
        ...
        branche='Handwerk',
        size_label='10–49 Mitarbeitende',
    ...
    4: dict(
        ...
        size_label='unter 10 Mitarbeitende',
