...
\begin{itemize}
  ...
  \item Optional und nur bei Ihrer freiwilligen Angabe: Ihre \textbf{E-Mail-Adresse für die Teilnahme an der Verlosung} (siehe Abschnitt „Verlosung / Gewinnspiel“), die getrennt von Ihren Befragungs\-antworten verarbeitet wird.
\end{itemize}
...
\begin{itemize}
  \item \textbf{Art.~6 Abs.~1 lit.~a DS-GVO} --- Ihre Einwilligung, die Sie durch das Anklicken des personalisierten Studien-Links im an Sie versandten Anschreiben erteilen, sowie Ihre gesonderte Einwilligung für die optionale Weitergabe Ihrer E-Mail-Adresse an das Klimareferat und für die Teilnahme an der Verlosung;
...
Eine \textbf{Weitergabe an weitere Dritte erfolgt grundsätzlich nicht}. Eine Ausnahme bildet die Weiterleitung Ihrer E-Mail-Adresse an das \textbf{Klimareferat der Stadt Frankfurt}, sofern Sie dieser Weiterleitung in der Befragung \textbf{ausdrücklich zugestimmt} haben, damit das Klimareferat zu verschiedenen Themen mit Ihnen Kontakt aufnehmen kann (z.\,B.\ zum Förderprogramm Klimabonus oder zur Einladung zu Veranstaltungen).

Die Daten werden ausschließlich in Deutschland und in der EU verarbeitet.

\section*{Verlosung / Gewinnspiel}

Als Anreiz zur Teilnahme verlosen wir unter allen Personen, die die Befragung abschließen, \textbf{fünf Amazon-Gutscheine im Wert von je 100~Euro}. Die Teilnahme an der Verlosung ist \textbf{freiwillig} und unabhängig von der Befragung: Sie können die Befragung vollständig abschließen, ohne an der Verlosung teilzunehmen.

Wenn Sie teilnehmen möchten, geben Sie am Ende der Befragung freiwillig Ihre \textbf{E-Mail-Adresse} an. Diese verwenden wir \textbf{ausschließlich zur Durchführung der Verlosung} (Ermittlung und Benachrichtigung der Gewinnerinnen und Gewinner sowie Versand der Gutscheine). Rechtsgrundlage ist Ihre Einwilligung nach \textbf{Art.~6 Abs.~1 lit.~a DS-GVO}, die Sie durch die freiwillige Angabe Ihrer E-Mail-Adresse erteilen und jederzeit widerrufen können.

Die zur Verlosung angegebene E-Mail-Adresse wird \textbf{getrennt von Ihren Befragungs\-antworten} verarbeitet, \textbf{nicht für die wissenschaftliche Auswertung} genutzt, nicht an Dritte weitergegeben und nach Abschluss der Verlosung und Versand der Gutscheine \textbf{unverzüglich gelöscht}.
...
Die \textbf{zur Verlosung} angegebene E-Mail-Adresse wird bereits \textbf{unmittelbar nach Abschluss der Verlosung} gelöscht (siehe Abschnitt „Verlosung / Gewinnspiel“).
